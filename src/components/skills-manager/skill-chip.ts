...
export const SKILL_CHIP_ICON_CLASS =
  'size-7 bg-background justify-center rounded-full p-0 [&>svg]:size-4 text-muted-foreground';

export const SKILL_CHIP_TEXT_CLASS =
  'h-7 rounded-[10px] bg-background px-2 text-[10px] leading-[14px] font-medium text-muted-foreground';
