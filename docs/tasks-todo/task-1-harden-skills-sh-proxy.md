...
Default proxy base: `https://skills-explorer.vercel.app` (override with `SKILLS_PROXY_BASE_URL`). Maintainer-only direct path: `SKILLS_SH_TOKEN` → call skills.sh from Rust.
