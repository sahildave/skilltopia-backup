 ...
 * carries. Seeded from lobehub's discover taxonomy (its `all` filter pseudo-
 * category and product-specific entries dropped). A skill may hold several;
 * the first is treated as primary (drives the icon in the UI).
 *
